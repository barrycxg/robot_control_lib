...
workspace_limits = np.asarray([[-0.88, -0.58], [-0.315, -0.115], [0.2, 0.35]]) # Cols: min max, Rows: x y z (define workspace limits in robot coordinates) measure your worklimits..
